...
<div id="layoutSidenav_content">
    ...
    <?php } ?>
    <main>
    <img src="https://img.freepik.com/free-vector/aurora-borealis-banner-northern-lights-arctic-night-sky-with-stars_107791-6937.jpg?w=1800&t=st=1685312382~exp=1685312982~hmac=1b082757bed3e3e1b63763a4fae07f2f3ea9bd0462ee49355aff364b09a825af" alt="Banner Image" class="banner-image">
    <div class="dashboard">
    <!-- Contenido principal -->
    <div class="main-content">
            <h1>Bienvenido(a) a la biblioteca <?php echo $_SESSION['nombre']; ?></h1>
            <p>En este espacio encontrarás todos los recursos necesarios para llevar a cabo los préstamos de libros a los estudiantes. Contamos con un completo registro de libros, autores, materias, editoriales y estudiantes, así como diversos reportes para un control eficiente de la biblioteca. Nuestro objetivo es brindarte una experiencia cómoda y eficaz al gestionar los préstamos de libros, facilitando el acceso a la información necesaria y agilizando los procesos administrativos. Explora nuestras funcionalidades y disfruta de una gestión bibliotecaria más ágil y organizada.</p>
            <br>
            <?php if ($_SESSION['rol'] == 1) { ?>
                <button class="btn btn-primary" type="button" data-toggle="modal" data-target="#prestar">
